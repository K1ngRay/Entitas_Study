...
public partial class GameEntity {
    ...
    public void AddSpeed(float newSpeed, float newAngularSpeed) {
        var index = GameComponentsLookup.Speed;
        var component = (SpeedComponent)CreateComponent(index, typeof(SpeedComponent));
        component.speed = newSpeed;
        component.angularSpeed = newAngularSpeed;
        AddComponent(index, component);
    }

    public void ReplaceSpeed(float newSpeed, float newAngularSpeed) {
        var index = GameComponentsLookup.Speed;
        var component = (SpeedComponent)CreateComponent(index, typeof(SpeedComponent));
        component.speed = newSpeed;
        component.angularSpeed = newAngularSpeed;
